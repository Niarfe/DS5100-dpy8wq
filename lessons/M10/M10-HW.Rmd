...
Note, finally, that you may not need all of the columns in `df` to
compute $C$.
...
When I run the below code you'll see that the data.frame fills out, but the values for commission are wrong starting after 0.4.
